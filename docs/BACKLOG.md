...
| N10 | Googles Freigabeverfahren für den Drive-Zugriff samt Datenschutzerklärung | 🟨 2026-08-19 | Vorbereitet: `drive.appdata` ist nach Kenntnisstand ein **nicht-sensibler** Scope — dann genügt „Testing → In Produktion“ ohne Prüfverfahren (die Konsole sagt es beim Veröffentlichen verbindlich). Die öffentliche Datenschutz-URL steht: `/datenschutz.html`, beim Build aus `docs/PRIVACY.md` erzeugt (eine Quelle, F7). Der Klick in der Konsole gehört dem Kontoinhaber — Schritte in OFFEN.md | M |
