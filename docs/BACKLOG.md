...
| # | Aufgabe | Status | Notizen | Aufwand |
|---|---|---|---|---|
| P1 | Unit-Tests für den Kern: Scheduler, Scoring, Sessionplanung — deterministisch | ✅ 2026-08-18 | 315 Tests laufen in Node, ganz ohne Browser — was zugleich D-010 belegt. Sessionplanung, Bewertung, Scheduler, Gesichtsgenerator, Messung, Profil, Reise-/Uhrfestigkeit und drei Trainingssprachen sind abgedeckt | M |
