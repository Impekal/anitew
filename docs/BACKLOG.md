...
| D5 | **Merktechniken werden beigebracht**, nicht nur abgefragt: Verknüpfung, Story-Methode, Major-System, Loci | 🟨 2026-08-17 | **D-013**. Das Major-System läuft: eine Ziffer je Lektion, vierzehn Sekunden aus dem Budget, danach steht der Konsonant unter jeder gelehrten Ziffer. Das **Wort zur Zahl liefert die App nicht** — selbst gebaute Bilder sitzen besser. Verknüpfung, Story-Methode und Loci fehlen noch (Loci hängt an G) | L |
...
| E2 | Acht Dimensionen … plus eine neunte | ✅ 2026-08-18 | **Zusammenhänge** kam dazu: Die Missionen üben, dass Zimmer, Gegenstand, Uhrzeit und Ort *zu einer Person gehören* (D-014) — eine eigene Fähigkeit, und die alltagsnächste. Zwei der acht (Visuell, Aufmerksamkeit) misst diese App noch nicht, und genau das steht dort; das Arbeitsgedächtnis zählt seit D7 als Sofort-Achse (D-026) | M |
...
| K3 | Achievements | ✅ 2026-08-18 | **D-019**. Benannte Tatsachen, keine Ränge: aus vorhandenen Zahlen gerechnet (Serie, Wiedersehen, Lernstand, Messungen, Palast), **nur was erreicht ist** — keine gesperrten Felder, kein Fortschrittsbalken, kein „0 von 8“. Am Anfang steht gar nichts. `core/progress/achievements.ts`, `tests/core/achievements.test.ts` | M |
