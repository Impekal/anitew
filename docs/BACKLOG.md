...
| L2 | Elf Sprachen: DE · EN · FR · ES · IT · PT · NL · TR · AR · ZH · JA | 🟨 2026-08-18 | **Trainieren** in sechs Sprachen (DE·EN·FR·ES·IT·PT, je voller eigener Inhalt samt Test); **Oberfläche** übersetzt in DE und EN — der UI-Wähler bietet seit 2026-08-26 nur noch Übersetztes an (TRANSLATION_WORKFLOW §6). NL·TR·AR·ZH·JA: kein Inhalt, technische Blocker in TRANSLATION_WORKFLOW §5 dokumentiert | L |
