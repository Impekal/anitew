...
export const en: Dictionary = {
  ...
  coach: {
    ...
    keyNote: 'With your own Anthropic key you can ask the coach free questions. The key stays on this device and travels only to api.anthropic.com with each question — there is no server in between. Each question costs a few cents from your own balance there.',
    keyPlaceholder: 'Anthropic key (sk-ant-…)',
    keySave: 'Save key',
    ...
    errors: {
      ...
      'bad-key': 'The key was not accepted. Check it in the Anthropic console — or remove it here.',
      offline: 'No connection to api.anthropic.com. Try again later — the notes above work offline.',
