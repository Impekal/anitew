...
export const en: Dictionary = {
  ...
  palace: {
    ...
    ownIntro: 'At least five places on a route you could walk blind. Always the same direction. You can append places and lay out further routes — a walk always covers five stops of one, never the whole route at once.',
    ownName: 'What is the route called?',
    ownNamePlaceholder: 'My flat',
    ownStation: 'Stop',
    ownStationPlaceholder: 'Place',
    ownSave: 'Keep the changes',
    ownCreate: 'Lay out the route',
    ownCancel: 'Cancel',
    ...
    ownFull: 'Eight routes are enough. More, and you never really arrive in any of them.',
    ownRule: 'At least five places, all different, none empty — and a name for the route.',
  },
  returns: {
    one: 'return',
    many: 'returns',
  ...
  reminder: {
    ...
    time: 'Time',
    timeHint: 'Digits only: the hour first, then the minutes. The field puts in the colon — type 07:15 as 0715.',
    save: 'Keep this time',
    off: 'No reminder',
    saved: 'Kept.',
    cleared: 'Off.',
  ...
  own: {
    ...
    inputLabel: 'Your material, line by line',
