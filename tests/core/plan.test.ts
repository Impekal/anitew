...
const plan = (mode: (typeof TRAINING_MODES)[number], seed = 'test') =>
  planSession({ mode, day: '2026-08-17', seed, pool })
...
describe('die Wortauswahl', () => {
  ...
  it('sagt deutlich Bescheid, wenn der Vorrat nicht reicht', () => {
    expect(() =>
      planSession({ mode: 'daily', day: '2026-08-17', seed: 'x', pool: ['eins', 'zwei'] }),
    ).toThrow(RangeError)
  })
})
